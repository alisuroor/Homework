	...
	System.setProperty("webdriver.chrome.driver", "C:/Users/syed/Desktop/testing/chromedriver.exe");
	   ...
	   driver.manage().window().maximize();
		...
		// Enter a valid email 
				...
				//validating successfull submission.
				
				Boolean  verifySubmit= driver.getCurrentUrl().contains("Book-visit");
				assertTrue(verifySubmit);
